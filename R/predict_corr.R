...
#'                 correlations. To avoid look-ahead, out-of-sample forecasts
#'                 (\code{out_of_sample = TRUE}) weight by \emph{filtered} probabilities
#'                 \eqn{\Pr(S_t \mid \Omega_t)}; the full-sample case uses \emph{smoothed}
