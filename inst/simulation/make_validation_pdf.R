...
# monte_carlo_study.R (CSV summaries + RDS bundle in results/).
...
"(33 parameters)} --- a dimension at which the pre-1.7-0 natural-space",
...
"high-dimensional feasibility barrier ($K = 5$, 33 parameters, 100/100)",
